...
PushNotification.prototype.setECB = function(successCallback, errorCallback, options) {
    ...
    if (typeof errorCallback != "function") {
        console.log("PushNotification.setecb failure: failure parameter not a function");
        return
    }

    if (typeof successCallback != "function") {
        console.log("PushNotification.setecb failure: success callback parameter must be a function");
        return
    }
